<?php require_once('../2.data/data-index.php') ?>
<?php require_once('../1.controller/controller-menubar.php') ?>
		...
		<div class="owl-carousel owl-theme home-slider">
			...
			<?php for ($i = 0; $i < count($slides); $i++) { ?>
				...
				<div class="slider-post slider-item-box-bkg">
					<div class="slider-img slide-3" style="background-image: url(<?php echo $slides[$i]['hinhAnh'] ?>)"></div>
					<div class="slider-caption">
						<div class="slider-text">
							<div class="intro-txt"><?php echo $slides[$i]['tieuDeNho'] ?></div>
							<h2><?php echo $slides[$i]['tieuDeLon'] ?></h2>
							<p><?php echo $slides[$i]['subTieuDe'] ?><br />
